...
export default function HomeScreen() {
    ...
    return (
        <SafeAreaView className={`flex w-full items-center h-full p-4 ${themeBg}`}>
            ...
            <View className="w-full flex gap-2">
                ...
                <TouchableOpacity className="z-20 absolute bottom-10 right-10 bg-blue-600 rounded-full p-4" onPress={() => console.log("Add new transaction")}>
                    <MaterialIcons name="add" size={24} color={themeIcon} />
                </TouchableOpacity>
        </SafeAreaView>
    )
}
